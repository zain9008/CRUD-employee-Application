      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
            A clean and simple homepage built with React and styled with
            Tailwind CSS.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-blue-50 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Optimized for speed and efficiency to provide the best user
                experience.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Built with security best practices to keep your data safe and
                protected.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Seamlessly integrates with cloud services for enhanced
                functionality.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <p className="text-xl font-semibold">My Website</p>
